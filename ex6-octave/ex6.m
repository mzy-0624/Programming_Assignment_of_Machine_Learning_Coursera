...
load('ex6data1.mat');   % Load from ex6data1: You will have X, y in your environment
...
load('ex6data1.mat');   % Load from ex6data1: You will have X, y in your environment
fprintf('\nTraining Linear SVM ...\n')
C = 1; % You should try to change the C value below and see how the decision boundary varies (e.g., try C = 1000)
...
fprintf('Loading and Visualizing Data ...\n')
load('ex6data2.mat');   % Load from ex6data2: You will have X, y in your environment
plotData(X, y);         % Plot training data
fprintf('Program paused. Press enter to continue.\n');
pause;
...
% The following code will load the next dataset into your environment and plot the data. 
fprintf('Loading and Visualizing Data ...\n')
load('ex6data3.mat');   % Load from ex6data3: You will have X, y in your environment
plotData(X, y);         % Plot training data
fprintf('Program paused. Press enter to continue.\n');
pause;
