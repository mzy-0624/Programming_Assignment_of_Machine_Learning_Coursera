...
load ('ex7data1.mat');  % The following command loads the dataset. You should now have the variable X in your environment
...
%  You should now implement PCA, a dimension reduction technique. You should complete the code in pca.m
...
[X_norm, mu, sigma] = featureNormalize(X);  % Before running PCA, it is important to first normalize X by subtracting the mean value from each feature
%  Run PCA
% [U, S] = pca(X_norm);
[U, S, K] = pcaWithFindK(X_norm);
...
% since working with all the data is too expensive. If you have a fast computer, you may increase this.
